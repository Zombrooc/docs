...
- **Itens individuais:**
  ...
  Diferente dos intervalos, itens individuais são aqueles que não seguem uma ordem númerica especifica, sendo utilizados quando há classificações como "Campeão", "Vice-Campeão" e afins. Nesse caso utilizamos o símbolo "," (Vírgula)  para definir cada elemento que queremos.
