...
- **Intervalos:** O padrão de intervalos tem como principal objetivo facilitar a escrita de classificações com diversos número como: 1º Lugar, 2º Lugar, 3º Lugar e afins.
  ...
  Para complementar o campo "Classificação" que irá gerar os números iniciais, podemos utilizar o campo nomeclatura para gerar qual definição será utilizada para essa classificação especifica. Logo se houver a necessidade de definir algo como "1ª Posição" ou "1º Colocado", o uso desse campo é o ideal.
